              ...
              <? $this->checkSessionTimeOut(); ?>
                <section class="top-bar-section">
                    <ul class="right">
                        ...
                        <li class="divider"></li>
                        <li<?=$this->controller == 'listings' ? ' class="active"' : ''?>><a href="?c=listings">Listings</a></li>
                        <li class="divider"></li>
                        <li<?=$this->controller == 'orders' ? ' class="active"' : ''?>><a href="?c=orders">Orders</a></li>
                        <li class="divider"></li>
                        <li class="has-dropdown not-click">
                            <a>Profile</a>
                            <ul class="dropdown">
                                <li><label>General</label></li>
                                <li<?=$this->controller == 'profile' && $this->action == 'settings' ? ' class="active"' : ''?>><a href="?c=profile&a=settings">Password and PIN</a></li>
                                  <li class="divider"></li>
                                <li<?=$this->action == 'pgpkey' ? ' class="active"' : ''?>><a href="?c=profile&a=pgpkey">PGP Key</a></li>
                                <li class="divider"></li>
                                <li<?=$this->action == 'bip32' ? ' class="active"' : ''?>><a href="?c=profile&a=bip32">BIP32 configuration</a></li>
                                <li class="divider"></li>
                                <li><label>Vendor profile</label></li>
                                <? if($this->user->is_vendor): ?>
                                <li><a href="?c=listings&a=vendor&u=<?=$this->h($this->user->name, false) ?>">Vendor page</a></li>
